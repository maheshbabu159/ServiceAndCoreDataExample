...
class InsertRecordViewController: BaseViewController {
    ...
    @IBAction func btnSaveClicked(sender: AnyObject)
    {
        ...
        else
        {
            if(isEdit)
            {
                ...
                let isUpdated = StudentModel.getInstance().updateStudentData(studentInfo)
                if isUpdated {
            ...
            else
            {
                ...
                studentInfo.Name = txtName.text!
                studentInfo.Marks = txtMarks.text!
                let isInserted = StudentModel.getInstance().addStudentData(studentInfo)
                if isInserted {
